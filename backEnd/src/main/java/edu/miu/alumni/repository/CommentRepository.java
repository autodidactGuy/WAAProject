...
public interface CommentRepository extends CrudRepository<Comment,Long> {
    ...
    @Query("select new edu.miu.alumni.model.CommentsResponse(c.id,c.id.comment,c.toStudent.id,c.writedBy.id) from Comment AS c where c.toStudent.id=:studentId ")
