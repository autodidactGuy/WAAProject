...
const Searchstudentandfacluty = () => {
  ...
  const getStudents = async(searchFilters)=>{
    if(getAccessToken()!=null){
        setIsLoggedIn(true);
        const response=await axios.post("/user/filterStudentsFaculty",searchFilters);
...
export default Searchstudentandfacluty;
